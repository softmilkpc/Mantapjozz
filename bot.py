...
from mantapjozz.check_user_status import handle_user_status
from mantapjozz.force_sub_handler import handle_force_sub
from mantapjozz.broadcast_handlers import main_broadcast_handler
from mantapjozz.database import Database
    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Channel", url="https://t.me/mantapvids"),
                        InlineKeyboardButton("Live Streaming", url="https://t.me/mantapjozzzz")
                    ],
                    [
                        InlineKeyboardButton("💻 WEBSITE 💻", url="https://doujindes.blogspot.com")
                    ],
                    [
        ...
        try:
            ...
            await send_stored_file.reply_text(
                f"**Share Link Gan: \n** https://t.me/{Config.BOT_USERNAME}?start=mantapjozz_{file_id}\n\n__Tap linknya untuk melihat file!__\n\n Join:**@mantapvids",
...
async def main(bot: Client, message: Message):
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support](https://t.me/mantapvids)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=mantapjozz_{file_er_id}"
            await editable.edit(
                f"**File mu sudah didalam Database gw!!**\n\nNeh Link Filemu, gas comot !!: {share_link} \n\nTap linknya untuk melihat file!__\n\n Join:**@mantapvids",
                parse_mode="Markdown",
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton("♻️Open Link♻️", url=share_link)],
                     [InlineKeyboardButton("Channel", url="https://t.me/mantapvids"),
                      InlineKeyboardButton("Channel 2", url="https://t.me/mantapfilestorage")]]
                ),
                disable_web_page_preview=True
            )
                ...
                [
                    [
                        InlineKeyboardButton("WEBSITE",
                                             url="https://doujindes.blogspot.com")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("Go Home", callback_data="gotohome")
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                     [
                        InlineKeyboardButton("Channel", url="https://t.me/mantapvids"),
                        InlineKeyboardButton("Channel", url="https://t.me/mantapfilestorage")
                    ],
                    [
                        InlineKeyboardButton("💻 WEBSITE 💻", url="https://doujindes.blogspot.com")
                    ],
